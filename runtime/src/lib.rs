...
pub use frame_support::{
	...
	parameter_types,
	traits::{
		AsEnsureOriginWithArg, //ADDEDLATER
		ConstBool, // ADDEDLATER,
		ConstU128,
		ConstU32,
		ConstU64,
		ConstU8,
...
/// Existential deposit.
// pub const EXISTENTIAL_DEPOSIT: u128 = 500; //ADDEDLATER
...
parameter_types! {
	...
	pub DeletionWeightLimit: Weight = BlockWeights::get().max_block; // added later
...
impl pallet_contracts::Config for Runtime {
	...
	// type ChainExtension = pallet_assets_chain_extension::substrate::AssetsExtension; // ADDEDLATER
	type ChainExtension = (); // TODO: update this value with some default available in 0.9.39; pallet_assets_chain_extension is available in 0.9.37
